...
class ContactResource(Resource):
    ...
    def get(self):
        ...
        try:
            ...
            return {"success": False, "message": "Failed to retrieve contacts"}, 500
...
class ContactDetailResource(Resource):
    ...
    def get(self, contact_id):
        ...
        try:
            ...
            return {"success": True, "contact": contact.to_dict()}, 200
    ...
    def delete(self, contact_id):
        ...
        try:
            ...
            return {"success": True, "message": "Contact deleted successfully"}, 200
...
class ContactStatsResource(Resource):
    ...
    def get(self):
        try:
            ...
            # By service type
            services = (
                db.session.query(Contact.service, db.func.count(Contact.id))
